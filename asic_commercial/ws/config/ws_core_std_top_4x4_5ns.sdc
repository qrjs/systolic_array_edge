...
set_input_delay -clock clk -max 1.000 [get_ports input_data_vec*]
set_input_delay -clock clk -min 0.250 [get_ports input_data_vec*]
...
set_input_delay -clock clk -max 1.000 [get_ports {input_valid_vec* weight_row_valid flush clk_enable}]
set_input_delay -clock clk -min 0.250 [get_ports {input_valid_vec* weight_row_valid flush clk_enable}]
