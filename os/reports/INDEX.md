# Output Stationary (os) 综合报告索引

## 架构说明
本目录包含 Output Stationary 架构的所有综合报告和Vivado工程文件。
...
``\bash
# 查看时序报告
cat os/reports/timing_report.txt

# 查看资源利用率
cat os/reports/utilization_report.txt

# 查看性能评估
cat os/reports/VIVADO_PERFORMANCE_EVALUATION_REPORT.md
