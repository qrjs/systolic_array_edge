...
# 设置顶层模块
set_property top systolic_array_is_4x4 [current_fileset]
...
# 执行综合
synth_design -top systolic_array_is_4x4 -part xc7a35tcpg236-1 -fanout_limit 400 -fsm_extraction one_hot -resource_sharing auto -max_bram -1 -max_dsp -1
