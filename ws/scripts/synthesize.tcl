#!/usr/bin/tclsh
#
# Vivado synthesis script (non-project flow) for WS array.
#
...
set top_name "systolic_array_4x4"
...
# Post-synth logic optimization helps improve Fmax on critical nets.
...
write_checkpoint -force "$reports_dir/ws_synth.dcp"
write_verilog -force "$reports_dir/ws_syn.v"
